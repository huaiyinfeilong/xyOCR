...
Это дополнение для NVDA обеспечивает  OCR (распознавание текста) в автономном и онлайн-режиме. Автономное распознавание разработано на основе компонента PaddleOCR_json.
...
Кроме того, это дополнение также предоставляет функцию описания изображений, которая позволяет идентифицировать содержимое изображения.
...
* Распознавание объекта навигатора: NVDA+ALT+O
...
Настройки клавиш быстрого доступа: В настройках "Жесты ввода" можно задать клавиши быстрого доступа для каждой команды в категории "Xinyi OCR".
...
* Удалён общий секретный ключ для Baidu OCR.
