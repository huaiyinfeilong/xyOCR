# Xinyi OCR (Распознавание текста Xinyi)
...
Кроме того, это дополнение также предоставляет функцию описания изображений, позволяющую анализировать их содержимое.
...
* Распознавание содержимого буфера обмена: NVDA+ALT+SHIFT+O
* Сменить движок распознавания OCR: NVDA+ALT+9
* Описание изображений: NVDA+ALT+P
* Описание изображений из буфера обмена: NVDA+ALT+SHIFT+P

Настройки горячих клавиш: В настройках "Клавиши и жесты" можно задать клавиши быстрого доступа для каждой команды в категории "Xinyi OCR".
...
* Добавлена функция распознавания содержимого буфера обмена, горячая клавиша: NVDA+SHIFT+ALT+O
